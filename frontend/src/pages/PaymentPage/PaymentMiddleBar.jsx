...
import { Box, Flex, Text, Input, Button, Image, Checkbox, Divider } from "@chakra-ui/react";
...
const PaymentMiddleBar = () => {
  ...
  return <Box w="100%" bg="white" padding="15px"
  ...
  >
    ...
    <Box mt="20px" mb="20px" w="100%">
      ...
      <Checkbox
        ...
        fontWeight={"500"}
        colorScheme="green"
        defaultChecked>save this as per rbi guidelines</Checkbox>
    </Box>
    <Box w="100%" m="auto">
